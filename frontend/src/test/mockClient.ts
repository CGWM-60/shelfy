...
export function createMockClient(): APIClient {
  return {
    ...
    getSettings: vi.fn().mockResolvedValue({ downloadMaxConcurrent: 3, downloadAutoResume: true, downloadAutoGroup: true, downloadsPath: '/tmp/downloads', libraryPaths: ['/tmp/media'], globalRateLimitKB: 0, aiEnabled: true, aiTopK: 5, theme: 'clair', visibleColumns: ['nom'], fileServerAuthEnabled: false, fileServerAuthUser: '', dlnaEnabled: false, smbEnabled: false, smbShareName: 'shelfy', smbSharePath: '/tmp/media' }),
    saveSettings: vi.fn().mockResolvedValue({ downloadMaxConcurrent: 3, downloadAutoResume: true, downloadAutoGroup: true, downloadsPath: '/tmp/downloads', libraryPaths: ['/tmp/media'], globalRateLimitKB: 0, aiEnabled: true, aiTopK: 5, theme: 'clair', visibleColumns: ['nom'], fileServerAuthEnabled: false, fileServerAuthUser: '', dlnaEnabled: false, smbEnabled: false, smbShareName: 'shelfy', smbSharePath: '/tmp/media' }),
